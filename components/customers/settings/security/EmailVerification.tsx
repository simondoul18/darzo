            ...
            <div className="linked-item">
                <div className="linked-wrap">
                    ...
                    <div className="linked-action">
                        <Link href="#" className="link-check"><i className="fa-solid fa-circle-check" /></Link>
                        <Link href="#" data-bs-toggle="modal" data-bs-target="#change-email" className="btn btn-primary btn-connect" onClick={() => setChange(true)}>Change</Link>
                        <Link href="#" className="btn-acc">Remove</Link>
                    </div>
                </div>
            </div>
            <div className={`modal fade custom-modal ${change === true ? "show d-block" : "d-none"}`} id="change-email">
